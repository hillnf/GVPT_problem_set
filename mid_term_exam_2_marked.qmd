...
::: {.callout-tip}
You need to use the t-statistic, not the z score, for means. 
:::
...
::: {.callout-tip}
Not quite. The probability that both rolls will be odd:
...
::: {.callout-tip}
You need to use the t-statistic for means.
:::
...
::: {.callout-tip}
Always calculate proportions. Do not work with raw counts. They are misleading. 
:::
...
::: {.callout-tip}
Your standard error for the difference of means is incorrect.  
:::
...
::: {.callout-tip}
Your t-statistic is incorrect because your SE is incorrect.
:::

df = 815 + 1593 -2 is 2,406

::: {.callout-tip}
The degrees of freedom are calculated by taking the smaller of the two sample sizes and subtracting 1. 
:::
...
::: {.callout-tip}
This question requires that you calculate the difference of proportions, not counts. 
:::
